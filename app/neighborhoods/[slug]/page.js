...
export default async function NeighborhoodListingsPage({ params, searchParams }) {
  ...
  // the Indian River, not the ocean. Also (per Ryan, 2026-08-10): hides the
  // generic backend-generated intro copy paragraph entirely — the "Find
  // homes for sale in Lansing Island, a community in Indian Harbour Beach,
  // FL..." boilerplate line under the H1.
