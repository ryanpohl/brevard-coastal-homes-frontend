...
//
// NOTE: the competitor site's "Suntree" page casts a wider net than this —
// it also includes separately-named communities like Baytree, St Andrews
// Manor, and several Viera Tract/Viera E subdivisions that don't contain
// "Suntree" in their own name at all (likely an MLS-area-code grouping
// rather than the community itself). Those were deliberately left out of
// this list rather than guessed in, since they're established community
// names in their own right on this site — flagged to Ryan to confirm
// before folding any of them in here.
