...
// the brokerage Ryan is actually licensed under. Plain hardcoded values
// (no env var) since these are legal/compliance text, not something that
// should silently go blank the way NEXT_PUBLIC_BUSINESS_PHONE did in the
// past (see this file's own AGENT_INFO comment / CLAUDE.md's 2026-08-04
// note) — a missing license number on a real estate site is a compliance
...
export const NEIGHBORHOOD_AREA_GUIDE_CONTENT = {
  ...
  laurasia: {
    ...
    homesites:
      'Laurasia is built exclusively by Viera Builders, with one- and two-story floor plans from its Inglenook and Silverado collections (listed starting in the $750s). Based on current MLS listings, active homes range $985,000–$1,225,000 across 2,931–5,189 square feet, on lots roughly a quarter- to half-acre.',
    schools:
  ...
  'pangea-park': {
    intro:
      'Pangea Park is a new-construction community by Viera Builders in South Viera, mixing single-family homes with condos across Craftsman, Modern Coastal, and Farmhouse-style elevations. Sidewalks link the neighborhood to nearby schools, shopping, and dining, with pricing that started around $420,000.',
    amenities:
    ...
    homesites:
      'Pangea Park is built exclusively by Viera Builders, mixing single-family homes with condos. Based on current MLS listings, homes range roughly $770,000–$830,000 (2,750–3,250 sq ft) and condos range roughly $428,000–$496,000 (1,480–1,920 sq ft).',
    schools:
  ...
  'reeling-park': {
    intro:
      'Reeling Park is a new-construction, courtyard-home community by Viera Builders in Viera, built around Traditional Neighborhood Design principles with Spanish Colonial-inspired architecture from its San Marco and Castillo Courtyard Collections — a style similar to Florida’s own St. Augustine. Pricing started in the $480s.',
    amenities:
    ...
    homesitesTitle: 'New Construction Homes',
    homesites:
      'Reeling Park is built exclusively by Viera Builders, with courtyard-style homes from its San Marco and Castillo Courtyard Collections (1,850–2,852 sq ft per the builder). Based on current MLS listings, active homes range roughly $557,000–$1,175,000 across 1,850–3,738 square feet, on lots roughly a tenth to a quarter acre.',
    schools:
  ...
  crossmolina: {
    intro:
      'Crossmolina is a new-construction community by Viera Builders in Viera, offering one- and two-story homes from its Mia and Ellis floor plan collections, starting at $540,000+. Homes range 1,960–3,108 square feet with flexible layouts supporting multigenerational living.',
    amenities:
  ...
  'farallon-fields': {
    intro:
      'Farallon Fields is a new-construction community by Viera Builders in west Viera, with one- and two-story homes inspired by mid-century modern design. Homes range from 1,740 to nearly 4,000 square feet, starting in the $500s, with a gated section available for added privacy.',
    amenities:
  ...
  'lansing-island': {
    intro:
      'Lansing Island is a private, guard-gated barrier-island community spanning Satellite Beach and Indian Harbour Beach, reached by a single causeway and covered drawbridge past a manned guardhouse. Fronting the Indian River Lagoon with the Banana River to the west and the Grand Canal to the east, nearly every homesite has direct water access, about a mile from the Atlantic Ocean.',
    amenities:
    ...
    homesitesTitle: 'Homes & Homesites',
    homesites:
      'Lansing Island mixes existing resale homes with ready-to-build vacant lots for custom construction — no single builder is tied to the community. Brevard Coastal Homes has no active MLS listings in Lansing Island as of this writing, so these figures come from the community’s own site and area real estate brokerages rather than live listings: existing homes start around $500,000, luxury waterfront estates have run $1.2 million to $5 million (average list price cited around $3 million), and homes here range roughly 3,000 to over 10,000 square feet on lots typically three-quarters of an acre to just under a full acre, with some larger parcels approaching two acres.',
    schools:
...
export const NEIGHBORHOOD_LISTINGS_FAQ = {
  laurasia: [
    ...
    },
    {
      ...
      a: 'Laurasia is built exclusively by Viera Builders, with pricing that started in the $750s across its Inglenook and Silverado collections.',
    },
    {
  ...
  'pangea-park': [
    {
      ...
      a: 'Pangea Park is a new-construction community by Viera Builders in South Viera, mixing single-family homes with condos across Craftsman, Modern Coastal, and Farmhouse-style elevations. Pricing started around $420,000.',
    },
    {
      q: 'Does Pangea Park have condos or just single-family homes?',
      a: 'Both — Pangea Park mixes single-family homes with condos. Based on current MLS listings, homes run roughly $770,000–$830,000 (2,750–3,250 sq ft) and condos run roughly $428,000–$496,000 (1,480–1,920 sq ft).',
    },
    {
  ...
  'reeling-park': [
    {
      ...
      a: 'Reeling Park is a new-construction, courtyard-home community by Viera Builders built around Traditional Neighborhood Design principles, with Spanish Colonial-inspired architecture similar to Florida’s own St. Augustine. Pricing started in the $480s.',
    },
    {
  ...
  crossmolina: [
    {
      ...
      a: 'Crossmolina is a new-construction community by Viera Builders offering one- and two-story homes from its Mia and Ellis floor plan collections, starting at $540,000+. Homes range 1,960–3,108 square feet with flexible layouts for multigenerational living.',
    },
    {
  ...
  'farallon-fields': [
    {
      ...
      a: 'Farallon Fields is a new-construction community by Viera Builders in west Viera, with one- and two-story homes inspired by mid-century modern design. Homes range from 1,740 to nearly 4,000 square feet, starting in the $500s, with a gated section available.',
    },
    {
  ...
  'lansing-island': [
    {
      ...
      a: 'Lansing Island is a private, guard-gated barrier-island community spanning Satellite Beach and Indian Harbour Beach, reached by a single causeway and covered drawbridge past a manned guardhouse. It fronts the Indian River Lagoon, with the Banana River to the west and the Grand Canal to the east.',
    },
    {
    ...
    {
      q: 'Can I buy a vacant lot in Lansing Island?',
      a: 'Yes — Lansing Island mixes existing resale homes with ready-to-build vacant lots for custom construction, typically three-quarters of an acre to just under a full acre. Brevard Coastal Homes has no active MLS listings here as of this writing — contact us to be notified as soon as something new comes on the market.',
    },
    {
