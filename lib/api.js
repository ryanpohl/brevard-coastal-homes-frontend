...
/**
 * @param {Object} params - any of city, neighborhood, propertyType, priceMin,
 *   priceMax, beds, baths, waterfront, zoning, sort, page, pageSize (see
 *   backend/README.md for the full list). Array values are comma-joined.
