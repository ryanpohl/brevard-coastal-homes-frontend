...
{/* Pending badge (2026-09-13, per Ryan: "Show all listings from the
                MLS...not just current ones" — clarified as Active + Pending).
                Cards previously only ever showed Active listings, so there was
                no need for a status badge here; now that Pending listings can
                appear in the same grids, this flags them so a visitor doesn't
                think an under-contract home is still open to offers. Sold/Off
                Market never reach this card at all (buildWhereClause's
